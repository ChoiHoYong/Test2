...
<body>	
	...
	<form action="main_process.jsp">
		<input name="haeng" required id="haeng"style="position:absolute; left:350px; top:110px; width:80px; text-align: center;">
		<input name="yeol" required id="yeol" style="position:absolute; left:350px; top:140px; width:80px; text-align: center;">
